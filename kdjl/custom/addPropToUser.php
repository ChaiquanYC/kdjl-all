...
<body>
<h1 style='text-align:center;'>派送道具</h1>
<div style="text-align:center;">
    ...
    <input type="button" onclick="addPToUGG();" value="派送道具（公告通知）">&nbsp;&nbsp;
            ...
            if(typeof parseInt(num) === 'number' && parseInt(num) == parseFloat(num)){
                if(num > 0){
                    if(confirm("确定要给该玩家派送道具吗？")){
            			...
            			var ajax=new Ajax.Request('./addPropToUserGate.php?act=addPropGG&userID='+userID+'&propID='+propID+'&num='+num, opt);
            		}
                }else{
                    alert("请输入大于0的整数！！！");
                }
