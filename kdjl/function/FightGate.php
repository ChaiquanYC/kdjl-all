...
$grs = getBaseGpcInfoById($_SESSION["fight".$_SESSION['id']]['gid']);
...
$v = getBaseGpcInfoById($_SESSION["fight".$_SESSION['id']]['gid']);
...
if(is_array($rs) && is_array($gs))  
{
	...
	$mem_welcome['crit_rate'] = getBaseWelcomeInfoByCode('crit_rate');
