...
if($map['multi_monsters']==4)
{
	...
	(
	intval($_GET['mapid']) <= 14 && intval($_GET['mapid']) >= 11)|| intval($_GET['mapid']) == 50 || intval($_GET['mapid']) == 124 || intval($_GET['mapid']) == 127 || intval($_GET['mapid']) == 143 || intval($_GET['mapid']) == 144 || intval($_GET['mapid']) >= 151)
	{
		$sql = "UPDATE player 
	...
	if (($user['inmap']>14 && $user['inmap'] != 50 && $user['inmap'] != 151 && $user['inmap'] != 124 &&  $user['inmap'] != 127  && intval($_GET['mapid']) != 143 && intval($_GET['mapid']) != 144) || $user['inmap'] < 11)// 地图限制
	{
